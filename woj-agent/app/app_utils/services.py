...
MEMORY_BANK_ID = os.environ.get("MEMORY_BANK_ID", "1185759518882004992")
...
def get_memory_service():
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-04-2db79b4332aa")
    location = (
    ...
    if location == "global":
        location = "us-east1"
    agent_engine_id = os.environ.get("MEMORY_BANK_ID", MEMORY_BANK_ID)
